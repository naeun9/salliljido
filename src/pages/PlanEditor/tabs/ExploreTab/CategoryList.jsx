                ...
                <EmptyState
                  icon={
                    <svg width="28" height="28" viewBox="0 0 26 26" fill="none">
                      <path d="M3.5 20V9.5L13 4l9.5 5.5V20" stroke="#2F5D50" strokeWidth="1.5" strokeLinejoin="round" />
                      <line x1="3.5" y1="20" x2="22.5" y2="20" stroke="#2F5D50" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                  }
                ...
                <EmptyState
                  icon={
                    <svg width="28" height="28" viewBox="0 0 26 26" fill="none">
                      ...
                      <line x1="13" y1="8" x2="13" y2="14" stroke="#2F5D50" strokeWidth="1.5" strokeLinecap="round" />
                ...
                <div className={styles.cardGrid}>
                  {visibleList.map((x) => (
                    <ExperienceCard
                      ...
                      durDays={durDays}
                      pickerOpen={expPickerId === x.id}
                      onTogglePicker={() => setExpPickerId(expPickerId === x.id ? null : x.id)}
                      onConfirm={(day, price) => {
