      ...
      {programs.length ? (
        ...
        <div className={styles.empty}>
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" className={styles.emptyIcon}>
            <rect x="3" y="5" width="20" height="16" rx="3" stroke="#555555" strokeWidth="1.4" />
            <line x1="3" y1="10.5" x2="23" y2="10.5" stroke="#555555" strokeWidth="1.4" />
            <rect x="7" y="14" width="7" height="3" rx="1.5" fill="#f0f0f0" />
          </svg>
