    ...
    >
      ...
      <span className={styles.dotWrap} style={{ width: size, height: size }}>
        <span
          ...
          style={{ background: color, border: dotBorder, boxShadow: dotShadow }}
        />
        {checked && (
          <span className={styles.check}>
            <svg width="12" height="12" viewBox="0 0 13 13" fill="none">
              <path d="M2 7l3 3 6-6.5" stroke="#D9784E" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
        )}
      </span>
